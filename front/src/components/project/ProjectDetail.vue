...
const fetchData = async (md5) => {
  try {
    ...
    const reponse_list_region = await axios.get(`/get_location?md5=${md5}`);
    domainRegionData.value = reponse_list_region.data;
    // console.log(domainRegionData.value)
    ...
    const responseLink_list = await axios.get(`/report/get_edges?md5=${md5}`);
    graphData.value = responseLink_list.data.graphData;
    graphData.value.links = responseLink_list.data.graphData.links.sort((a, b) => b.weight - a.weight);
    ...
    const ps4 = new PerfectScrollbar(region_bar.value, {
      wheelSpeed: 0.3,
      wheelPropagation: false,
      minScrollbarLength: 20
    });
    const ps5 = new PerfectScrollbar(report_taokebar.value, {
      wheelSpeed: 0.3,
      wheelPropagation: false,
      minScrollbarLength: 20
    });
...
<template>
  <div class="container-xxl flex-grow-1 container-p-x">
    <div class="container-p-y" style="min-height: 80vh; height: 170vh;">
      <div class="row" style="height: 50%">
        ...
        <div class="col-lg-6 col-md-6 mb-4" style="height: 100%">
          ...
          <!--       IP定位      -->
          <div class="card mb-4" style="height: 57%">
            <div class="card-body ipMap" style="padding-top: 1rem; margin-bottom: 0">
              <div class="row flex-wrap align-items-center ip_header">
                <i class='bx bxs-map bx-sm ip_icon' style="color: #566a7f"></i>
                <span class="fw-bolder fs-5 m-lg-1 ip_title">IP 追踪定位</span>
              </div>
              <div class="" id="" style="height: 83%; margin-top: 2%; margin-bottom: 0;">
                <ip-tracking :passmd5="md5"></ip-tracking>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 col-md-6 mb-4" style="height: 100%;">
          ...
          <div class="card mb-4" style="height:100%; min-height: 0px">
            ...
            <div ref="report_content" class="report card-body mb-3 pt-0"
              ...
              <h4 v-if="!isloading" class="eachh-title">一、IP 地址分析（IP Analysis）</h4>
              <div class="parent-class" v-html="parsedMarkdown0" id="report0"></div>
              <h4 v-if="!isloading" class="eachh-title">二、权限分析（Permission Analysis）</h4>
              <div class="parent-class" v-html="parsedMarkdown1" id="report1"></div>
              <h4 v-if="!isloading" class="eachh-title">三、活动分析（Activity Analysis）</h4>
              <div class="parent-class" v-html="parsedMarkdown2" id="report2"></div>
              <h4 v-if="!isloading" class="eachh-title">四、证书分析（Certificate Analysis）</h4>
              <div class="parent-class" v-html="parsedMarkdown3" id="report3"></div>
              <h4 v-if="!isloading" class="eachh-title">五、总结（Summary）</h4>
              <div class="parent-class" v-html="parsedMarkdown4" id="report4"></div>
              <h4 v-if="!isloading" class="eachh-title">六、局限性（Limitations）</h4>
      ...
      <div class="row mt-4" style="height: 50%">
        <div class="col-lg-6 col-md-6 mb-4" style="height: 100%">
          ...
          <div class="card mb-4" style="height: 45%">
            <div class="card-body">
              ...
              <div class="" style="">
                <Probability_distribution_chart></Probability_distribution_chart>
              </div>
            </div>
          </div>
          ...
          <!--        地区         -->
          <div class="card mb-4" style="height: 45%">
            <div class="card-body" style="height: 100%; padding-right: 0">
              <div class="col-lg-12 col-md-12" style="height: 100%">
                <div class="row flex-wrap align-items-center ip_header">
                  <i class='bx bx-globe bx-sm ip_icon' style="color: #566a7f"></i>
                  <span class="fw-bolder fs-5 mx-2 ip_title">涉及地区</span>
                </div>

                <div ref="region_bar" class="table-responsive text-nowrap pb-3 mt-3"
                     style="padding-right: 3%; max-height: 85%; overflow: auto">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr v-for="(item, index) in domainRegionData" :key="index">
                      <td class="pack_bar">{{ item.domain }}</td>
                      <td>{{ item.ip }}</td>
        ...
        <div class="col-lg-6 col-md-6 mb-4" style="height: 100%">
          ...
          <div class="card" style="height: 45%">
            <div class="card-header d-flex align-items-center justify-content-between">
              <h5 class="card-title m-0 me-2">套壳APP分析</h5>
            </div>
            <div ref="report_taokebar" class="card-body overflow-auto" id="vertical-example" style="max-height: 400px;">
